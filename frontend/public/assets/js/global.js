(function () {
    ...
    target.innerHTML = `
      <header class="site-nav-wrap">
        <nav class="site-nav" aria-label="Primary navigation">
          <a class="brand" href="index.html" aria-label="PK_Tech_Warrior home">PK_Tech_Warrior</a>
    ...
    target.innerHTML = `
      <footer class="site-footer">
        <div class="footer-grid">
          <div>
            <h2 class="footer-title">PK_Tech_Warrior</h2>
        ...
        <div class="footer-copy">© 2026 PK_Tech_Warrior — Built by Praveen Kannan</div>
      </footer>
    `;
  }
  ...
  const knowledge = [
    [["about", "PK_Tech_Warrior", "company"], "PK_Tech_Warrior is Praveen Kannan's premium AI company for AI systems, chatbots, automation platforms, dashboards, cybersecurity tools, data analytics, and full-stack digital experiences."],
    ...
    [["service", "services", "offer", "build", "make", "develop"], "PK_Tech_Warrior builds AI automation, AI chatbots, full-stack apps, AI dashboards, cybersecurity systems, analytics platforms, and business automation workflows."],
    ...
    [["project", "portfolio", "case study", "work"], "Featured PK_Tech_Warrior projects include AI Chatbot Platform, Analytics Dashboard, Gym Management System, AI Automation Platform, Cybersecurity Dashboard, and Portfolio System."],
    [["technology", "stack", "tools", "database", "backend", "frontend"], "The PK_Tech_Warrior stack includes Node.js, Express, MongoDB, Mongoose, JWT, Cloudinary, Nodemailer, OpenAI, Gemini, Three.js, GSAP, Swiper, Tailwind, and modern frontend architecture."],
    [["price", "pricing", "cost", "budget", "quote"], "PK_Tech_Warrior does not use public subscriptions or fixed pricing. Every project is scoped privately with Praveen after understanding your goals, timeline, integrations, and required AI features."],
    ...
    [["chatbot", "assistant", "bot"], "PK_Tech_Warrior can build custom AI chatbots with website knowledge, lead capture, multilingual support, admin review, OpenAI or Gemini integration, and safe fallback answers."],
    [["automation", "workflow", "automate"], "PK_Tech_Warrior automation systems can connect forms, CRMs, dashboards, APIs, notifications, reports, and AI decisions so repetitive work runs with less manual effort."],
    [["dashboard", "analytics", "data", "report"], "PK_Tech_Warrior creates premium AI dashboards for business metrics, analytics, operations, cybersecurity visibility, customer insights, and executive decision-making."],
    [["security", "cybersecurity", "secure"], "PK_Tech_Warrior can design cybersecurity dashboards and secure application layers with admin authentication, protected APIs, careful data handling, and monitoring workflows."],
    [["mobile", "responsive", "phone"], "The PK_Tech_Warrior website and platforms are designed to adapt across desktop, tablet, and mobile with cinematic visuals, readable sections, and touch-friendly controls."],
    [["admin", "login", "credentials"], "The PK_Tech_Warrior admin area is private for the owner only. It manages projects, resources, messages, payment proofs, testimonials, analytics, settings, and chatbot knowledge."]
  ];
  ...
  function localAssistant(message) {
    ...
    if (/\b(can|could|will|do)\b.*\b(build|create|make|develop|design|automate|integrate)\b/.test(text)) {
      return "Yes. PK_Tech_Warrior can build custom AI systems, chatbots, automations, dashboards, cybersecurity tools, data products, and full-stack applications. Share your idea through the contact form or email Praveen directly so the project can be scoped.";
    }
    const hit = knowledge.find(([keys]) => keys.some((key) => text.includes(key)));
    if (hit) return hit[1];
    if (text.includes("?")) {
      return "That sounds like a custom PK_Tech_Warrior project question. Praveen can help clarify the best AI architecture, automation flow, database, dashboard, or deployment plan. Send the details through Contact Me or email praveenkicha01@gmail.com.";
    }
    return "I can help with PK_Tech_Warrior services, custom project ideas, AI chatbots, automation, dashboards, cybersecurity, technology stack, pricing approach, timelines, portfolio, contact details, and navigation.";
  }
  ...
  function setupChatbot() {
    ...
    panel.setAttribute("aria-label", "PK_Tech_Warrior AI Assistant");
    panel.innerHTML = `
      <div class="chat-head">
        <strong>PK_Tech_Warrior AI Assistant</strong>
    ...
    launcher.setAttribute("aria-label", "Open PK_Tech_Warrior AI Assistant");
