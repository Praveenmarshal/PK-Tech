const resourceData = {
  "future-of-ai-automation": {
    ...
    sections: [
      ...
      { heading: "4. Real World Applications", body: "PK_Tech_Warrior applies AI automation to intelligent chatbots, lead qualification pipelines, executive dashboards, internal knowledge tools, cybersecurity visibility, data analytics platforms, and end-to-end business process automation across industries." },
