(function () {
  ...
  function token() {
    return localStorage.getItem("PK_Tech_Warrior_admin_token");
  }
  ...
  function renderSidebar() {
    ...
    target.querySelector("[data-admin-logout]")?.addEventListener("click", () => {
      localStorage.removeItem("PK_Tech_Warrior_admin_token");
      localStorage.removeItem("PK_Tech_Warrior_admin_user");
      window.location.href = "admin-login.html";
    });
  }
