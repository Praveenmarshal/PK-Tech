...
async function seed() {
  ...
  await Testimonial.insertMany([
    { name: "Rohan Verma", role: "Founder", quote: "PK_Tech_Warrior turned our AI idea into a clean, premium platform with real workflow value." },
    { name: "Nila Shah", role: "Operations Lead", quote: "The dashboard made our business data feel calm, readable, and immediately useful." }
  ]);
  console.log("PK_Tech_Warrior seed data inserted.");
